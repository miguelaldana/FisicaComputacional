/** 
    ...
    Output:
    - Archivo_1 = posiciones y velocidades de las particulas en los proximos 5 mil millones de anos.
    - Archivo_2 = posiciones y velocidades de las particulas en los proximos 10 mil millones de anos.
    - Archivo_3 = posiciones y velocidades de las particulas en los proximos 15 mil millones de anos.
    - Archivo_4 = posiciones y velocidades de las particulas en los proximos 20 mil millones de anos.
    - Archivo_5 = posiciones y velocidades de las particulas en los proximos 25 mil millones de anos.
**/
...
int main (int argc,char **argv){
  ...
  char evolucion1[100] = "Datos_evolucion_1.dat";
  char evolucion2[100] = "Datos_evolucion_2.dat";
  char evolucion3[100] = "Datos_evolucion_3.dat";
  char evolucion4[100] = "Datos_evolucion_4.dat";
  char evolucion5[100] = "Datos_evolucion_5.dat";
...
// definición de los vectores condiciones iniciales. Con esto se hace un scan que obtiene las variables del problema anterior y las convierte en xi (float) y yi(float), y las velocidades iniciales vix(float) y viy(float).
 ...
 in = fopen(evolucion1, "w");
 fprintf(in,"nulo");
 fclose(in);

 in = fopen(evolucion2, "w");
 fprintf(in,"nulo");
 fclose(in);

 in = fopen(evolucion3, "w");
 fprintf(in,"nulo");
 fclose(in);

 in = fopen(evolucion4, "w");
 fprintf(in,"nulo");
 fclose(in);

 in = fopen(evolucion5, "w");
 fprintf(in,"nulo");
 fclose(in);
